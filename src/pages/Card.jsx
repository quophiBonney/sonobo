        ...
        <Row className="justify-content-center">
          <Col sm={12} md={4} lg={4} className="mt-5">
            <div className="py-3 px-3 card">
              <h3 className="text-center">Telco Charges</h3>
              <p>
          ...
          <Col sm={12} md={4} lg={4} className="mt-5">
            <div className="py-3 px-3 card">
              <h3 className="text-center">E-Levy Charges</h3>
              <p>
                This charges comes from the government, this charges comes in
                the form tax on all your withdrawals. The charge is 15% in total
                or deduction.
              </p>
            </div>
          </Col>
          <Col sm={12} md={4} lg={4} className="mt-5">
            <div className="py-3 px-3 card">
              <h3 className="text-center">Quick Notice</h3>
              <p>
